...
UI = {
    ...
    "picker": {
        ...
        "blockTitle": "5-hour windows",
        "colDate": "Date",
        "colStart": "Start",
        "colEnd": "End",
        "blockOngoing": "Ongoing",
        "dateFrom": "From",
        "dateTo": "To",
        "blockEmpty": "No window in this range",
        "windowsPaginationAria": "Windows pagination",

        "customPeriod": "Select period",
        "pastMonths": "Past months",
        "back": "Back",
        "pickMonth": "Month",
        "pickMonthPlaceholder": "Choose a month…",
        "apply": "Apply",
        "customRangeInvalid": "Choose two valid dates",
    },
    ...
    "period": {
        ...
        "year": "This year",
        "yearShort": "Year",
        "block": "Current window since {start}",
        "blockShort": "since {start}",
        "blockPast": "{start}–{end}",
    },
